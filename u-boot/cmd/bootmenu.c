				...
				enum bootmenu_key *key, int *esc)
{
	...
	if (menu->delay > 0) {
		...
		printf(" Hiro hiro 1 : Hit any key to stop autoboot: %2d ", menu->delay);
	}
...
static void bootmenu_show(int delay)
{
	...
	puts("returned from menu_create\n");
	if (!menu) {
	...
	puts("Hiro I am in bootmenue_show\n");
